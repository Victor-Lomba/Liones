    ...
    >
      <div className={style["character"]}>
        ...
        <div className={`${style["divImg"]} ${style["divImgMutant"]}`}>
          <img
            src={`/images/imgs/pages/Personagem/RacasEClasses/races/mutant/mutant.png`}
            alt="Deu ruim"
          />
          <img
            src={`/images/imgs/pages/Personagem/RacasEClasses/races/mutant/mutant-parts.png`}
            alt="Deu ruim"
          />
          <img
            src={`/images/imgs/pages/Personagem/RacasEClasses/races/mutant/mutant-parts2.png`}
            alt="Deu ruim"
          />
        </div>
      </div>
